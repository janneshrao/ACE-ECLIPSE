...
public class TASK_INTEGRATION_TESTS_TASK_INTEGRATION_TESTS_MSG_FLOW_Compute_0001_Test {

	/*
	 * TASK_INTEGRATION_TESTS_TASK_INTEGRATION_TESTS_MSG_FLOW_Compute_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.3.0 on May 9, 2024 4:29:32 PM
	 */
	...
	@Test
	public void TASK_INTEGRATION_TESTS_TASK_INTEGRATION_TESTS_MSG_FLOW_Compute_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("TASK_INTEGRATION_TESTS")
				.messageFlow("TASK_INTEGRATION_TESTS_MSG_FLOW").node("Compute");
		...
		try {
			String inputResourcePath = "/testXMLData.xml";
		...
		try {
			...
			String expectedResourcePath = "/testJSONData.json";
			InputStream resourceStream = Thread.currentThread().getContextClassLoader()
